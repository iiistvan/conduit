...
testdata = ['tesztalany107', 'tesztalany107@ta.hu', 'Conduit003']
...
try:
    ...
    print('Elérhető a Sigp Up felirat.')
    ...
    signup_btn.click()
    time.sleep(1)
    assert driver.find_element_by_xpath('//div[@class="swal-title"]').text == text
    ...
    #     signup_btn.click()
    #     time.sleep(2)
    #     if driver.find_element_by_xpath('//div[@class="swal-title"]').text == text:
    #         driver.find_element_by_xpath('//div[@class="swal-button-container"]//button').click()
    #         time.sleep(1)
